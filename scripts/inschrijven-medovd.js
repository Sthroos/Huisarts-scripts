(function() {
    ...
    function fillForm(data) {
        ...
        if (data['Voorletters']) {
            ...
            if (fillField(targetDoc, 'patientPersoonWrapper.persoon.voorletters', voorletters)) filled++;
        }
        ...
        if (data['Geslacht']) {
            ...
            if (fillField(targetDoc, 'patientPersoonWrapper.persoon.geslachtString', geslacht)) filled++;
        }
        ...
        if (data['Type ID bewijs']) {
            ...
            if (fillField(targetDoc, 'patientPersoonWrapper.persoon.widDocSoort', typeValue)) filled++;
        }
    ...
    function isPatientFormPage() {
        ...
        try {
            ...
            // Check if iframe has loaded the patient form
