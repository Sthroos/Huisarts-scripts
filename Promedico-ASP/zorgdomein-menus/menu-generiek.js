// zorgdomein-menus/menu-generiek.js
// Generiek landelijk menu — alleen supply-matcher en healthcare-request URLs.
// Deze URLs werken in alle regio's; Zorgdomein selecteert zelf de aanbieder.
// Geen choose-product UUIDs (die zijn regio-specifiek).

const ZORGDOMEIN_MENU_ITEMS_GENERIEK = [
    // --- 1. DIAGNOSTIEK ---
    {
        text: 'Diagnostiek',
        code: 'LAB',
